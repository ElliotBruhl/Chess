...
public class Gui { 
    ...
    public Gui(Board b) {
        pathArr = new String[]{"files\\Chess_plt45.png","files\\Chess_pdt45.png","files\\Chess_rlt45.png","files\\Chess_rdt45.png","files\\Chess_nlt45.png","files\\Chess_ndt45.png",
                        "files\\Chess_blt45.png","files\\Chess_bdt45.png","files\\Chess_qlt45.png","files\\Chess_qdt45.png","files\\Chess_klt45.png","files\\Chess_kdt45.png"};
        board = b;
        initializeFrame();
        initializeBoard();
    ...
    private void highlightLegalMoves(int start) {
        long legalMoves = board.getLegalMoves(new int[]{start})[0];
        for (int i = 0; i < 64; i++) {
            if ((legalMoves & (1L << 63-i)) == 0L) continue; //not in legal moves
            buttons[(((7 - (i/8))*8 + (i%8)))].setBackground(highlight); // light square highlight
        }
    }
    ...
    public int[] getClicks() {
        return new int[]{startClick, endClick};
    }
