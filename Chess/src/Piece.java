...
public final class Piece {
    ...
    public ArrayList<Integer> getLegalMoves(int index, Board b, boolean fullLegal) { //fullLegal is false when checking if a king is in check and true otherwise
        ...
        switch (pos[index].getPieceID()) {
            ...
            case 'N': //knights
            case 'n':
                addKnightMoves(legalMoves, index, pos);
                break;
            case 'B': //bishops
            case 'b':
        ...
        if (fullLegal) {
            System.out.println("Pseudo-legal:" + legalMoves); //for testing
            removePsedoLegal(legalMoves, index, b);
            System.out.println("legal:" + legalMoves); //for testing
        }
        
        return legalMoves;
    }
    private void removePsedoLegal(ArrayList<Integer> legalMoves, int index, Board oldBoard) { //index is starting square of piece
    ...
    private void addWhitePawnMoves(ArrayList<Integer> legalMoves, int index, Piece[] pos, int ePT) {
        int row = index / 8;
        int col = index % 8;
    ...
    private void addBlackPawnMoves(ArrayList<Integer> legalMoves, int index, Piece[] pos, int ePT) {
        int row = index / 8;
        int col = index % 8;
    ...
    private void addRookMoves(ArrayList<Integer> legalMoves, int index, Piece[] pos) {
    ...
    private void addBishopMoves(ArrayList<Integer> legalMoves, int index, Piece[] pos) {
    ...
    private void addKnightMoves(ArrayList<Integer> legalMoves, int index, Piece[] pos) {
    ...
    private void addKingMoves(ArrayList<Integer> legalMoves, int index, Piece[] pos) {
